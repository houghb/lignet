...
# net.get_params()
param_grid = {'hidden0_num_units': range(4, 25),
              'hidden1_num_units': range(4, 25)
              }
grid_search = GridSearchCV(net, param_grid, verbose=0, n_jobs=25,
...
#grid_search.best_estimator_.save_params_to('double_hidden_best_params2.dat')
with open('double_hidden_ann_objects3.pkl', 'wb') as pkl:
