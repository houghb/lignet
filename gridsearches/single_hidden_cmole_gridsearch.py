...
# net.get_params()
param_grid = {'hidden0_num_units': range(10, 60),
...
grid_search.best_estimator_.save_params_to('single_hidden_best_params.dat')
with open('single_hidden_ann_objects.pkl', 'wb') as pkl:
